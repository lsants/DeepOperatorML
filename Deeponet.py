...
# ----------- Save output ------------
np.savez("/users/lsantia9/research/high_performance_integration/data/info/test_output.npz", u=u_test, xt=xt, real=g_u_pred_real_test, imag=g_u_pred_imag_test, mu_u=mu_u, sd_u=sd_u, mu_xt=mu_xt, sd_xt=sd_xt)
