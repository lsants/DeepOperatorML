...
from ..nn.network_factory import NetworkFactory
...
class OutputHandler(ABC):
    ...
    @abstractmethod
    def compute(self, branch_out: Iterable[torch.Tensor], trunk_out: Iterable[torch.Tensor]):
        pass

    @abstractmethod
    def validate_dimensions(self, branch_dim: int, trunk_dim: int):
        pass
