...
class JacobiKANLayer(torch.nn.Module):
    def __init__(self, input_dim, output_dim, degree, a=1.0, b=1.0):
        ...
        self.jacobi_coeffs = torch.nn.Parameter(torch.empty(input_dim, output_dim, degree + 1))
        
        torch.nn.init.normal_(self.jacobi_coeffs, mean=0.0, std=1/(input_dim * (degree + 1)))
...
#        self.ln1 = torch.nn.LayerNorm(32) # To avoid gradient vanishing caused by tanh
        self.ln1 = torch.nn.Tanh()
        self.jacobikan2 = JacobiKANLayer(32, 32, 3, a=1.0, b=1.0)
        self.ln2 = torch.nn.Tanh()
        self.jacobikan3 = JacobiKANLayer(32, 3, 3, a=1.0, b=1.0)
#        self.ln2 = torch.nn.LayerNorm(32)
#        self.ln2 = torch.nn.LayerNorm(32)
        self.ln3 = torch.nn.Tanh()
