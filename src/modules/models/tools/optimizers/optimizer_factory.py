...
import torch
from src.modules.models.tools.optimizers.optimizers import OPTIMIZER_MAP, SCHEDULER_MAP
from src.modules.models.tools.optimizers.config import OptimizerSpec


def create_optimizer(spec: 'OptimizerSpec', params: list[torch.nn.Parameter]) -> torch.optim.optimizer.Optimizer:
...
def create_scheduler(spec: 'OptimizerSpec', optimizer: torch.optim.optimizer.Optimizer) -> torch.optim.lr_scheduler._LRScheduler | None:
