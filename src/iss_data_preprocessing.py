...
u_train, trunk_features, labels_train_r, labels_train_z = d_train['X_branch'],d_train['X_trunk'], d_train['y_r'], d_train['y_z']

u_train = preprocess(u_train)
...
u_test, trunk_features, labels_test_r, labels_test_z = d_test['X_branch'],d_test['X_trunk'], d_test['y_r'], d_test['y_z']

u_test = preprocess(u_test)
