...
import src.problems.kelvin.problem_dependent_post_processing as postp

logger = logging.getLogger(__file__)

def plot_metrics(results_dir: str, output_dir: str) -> None:
    ...
    data_for_2D_plotting = postp.postprocess_for_2D_plot(model=model, 
    ...
    modes_to_highlight = postp.get_modes_indices_to_highlight(coeffs_mean_abs, test_config["PRINCIPAL_MODES_TO_PLOT"])
